        ...
        return(
            <div className="Products">

                {
                    ...
                    <div className="addedToCart">
                        <div className="addedBox">
                            ...
                            <Link to='/shop'><button className="buttonss">CONTINUE SHOPPING</button></Link>
                        </div>
                    </div>     
                    :
                    null
                ...
                <div className="bottomPortion">
                    ...
                    <p className="para">This logo was created by Dennis Cortés, a full-time, professional designer and illustrator. This logo was hand-crafted in a very intentional and strategic way to fit the needs and standards of today's industries. You can be confident this logo's elements and quality will represent your idea the way it deserves, we promise.</p>
                    ...
                    <div className="whatYouGet">
                        ...
                        <ul className="dumb">
                            ...
                            <li>Every logo file you will ever need including:</li>
                                <ul className="ul">
                                    ...
                                    <li>Guide for use and ZIP file for easy sharing with designers, developers, and manufacturers</li>
                        ...
                        <button className="btn" onClick={this.moveToCart}>Add To Cart</button>
                        </div>

                            <p className="note">NOTE: For your security, you will be sent to Plasso.co to finish purchase and download your files ♥</p>
                    </div>
                </div>
