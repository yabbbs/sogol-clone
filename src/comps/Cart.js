...
class Cart extends Component{
    ...
    render(){
        ...
        const bought  = this.props.cart.map((carty, i )=>{
            return(
                <CartProduct key={i} id={carty} removeFromCart={this.props.removeFromCart}/>
            )
        }
    )
        ...
        return(
            <div className="Cart">
                ...
                <StripeCheckout className="btn" token={this.onToken} stripeKey="pk_test_US6VcPMEOdKnD1ibZRqTfVGM"/>
                </div>
