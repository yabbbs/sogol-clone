...
export default class FAQ extends Component{
    ...
    render(){
        const allLogos = this.state.logos.map((currentLogo, i)=>{
            return (
                <LogoTile key={i} logo={currentLogo}/>
            )
        })
        ...
        return(
            <div className="ShopLogo">
                ...
                <div className="second-headers">
                    ...
                    <p className="body">Good design is expensive, bad design will make you bankrupt. Let us help you get what your idea deserves. Each logo is just $249 and comes with every file you'll ever need. <br/><br/> Every logo here can only be bought once. Once you purchase, you alone get exclusive rights to it. You can do whatever you wish with them: add color, alter the shape, add type, etc. </p>
                </div>
                </div>
